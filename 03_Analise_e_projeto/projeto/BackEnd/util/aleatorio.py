...
class GeraDados:
   ...
   def sobrenome(self):
       sobrenomes = ["Silva", "Santos", "Costas", "Machado", "Oliveira", "Souza", "Sousa", "Lima", "Pereira", "Ferreira", "Rodrigues", "Almeida", "Nascimento", "Alves", "Carvalho", "Araújo", "Ribeiro", "Andrade", "Barbosa", "Barros", "Borges", "Campos", "Dias", "Garcia", "Gomes", "Lima", "Martins", "Mello", "Monteiro", "Morais"]
       sorteio = self.numeroInt(0,len(sobrenomes))
       return sobrenomes[sorteio]

   def nomescompletos(self, qtd):
       nomescompletos = self.nome() + " " + self.sobrenome() + " " + self.sobrenome()
